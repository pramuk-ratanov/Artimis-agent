      ...
      <div className="max-w-[65ch] mx-auto">
        ...
        {loading ? (
          ...
          <div className="space-y-2">
            {notes.map(n => (
              <div key={n.id} className="bg-surface-1 border border-surface-3 rounded-card p-3">
                <p className="text-body font-semibold text-ink-primary mb-0.5">{n.title}</p>
                <p className="text-label text-ink-secondary truncate" style={{ fontFamily: "var(--font-sans)" }}>
